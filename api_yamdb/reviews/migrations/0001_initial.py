# Generated by Django 3.2 on 2023-02-21 17:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(verbose_name='Краткое имя категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(verbose_name='Краткое имя жанра')),
            ],
            options={
                'verbose_name': 'Жанр',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='genres', to='reviews.genre', verbose_name='Жанр')),
